...
from .EvalBox.Attack.attack_eval import AttackEval
...
def main(args: Dict) -> NoReturn:
    ...
    if recipe in _ATTACK_RECIPES:
        ...
        recipe_cls = getattr(
            importlib.import_module(f"{module_name}.EvalBox.Attack.{recipe}"),
    ...
    if config_file is None:
        config_file = os.path.join(
            module_dir, "EvalBox", "Attack", "default_configs.yml"
        )

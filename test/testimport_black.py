...
def main(arg1,arg2):
    ...
    if  arg1.ONLY_GENRATE_BLACK_SAMPLE:
        for f in files:
            arg1.attack_method = [attName[0], "", "attack_param/" + attName[0] + "/" + f]
            print(arg1.attack_method)
            #####新建的攻击类的对象#####
            r_a=Rebust_Attack(arg1.attack_method,image_path,
                        label_path,image_origin_path,
                        label_origin_path,int(arg1.GPU_Config[0]),arg1.GPU_Config[1],10,arg1.Scale_ImageSize,arg1.Crop_ImageSize,\
                            arg1.model, arg1.model_dir, arg1.defense_model,\
                            arg1.model_defence_dir, arg1.data_type, arg1.IS_WHITE, \
                            arg1.IS_SAVE, arg1.IS_COMPARE_MODEL, arg1.IS_TARGETTED, arg1.save_path, arg1.save_method,\
                            arg1.black_Result_dir, arg1.batch_size)
            #####产生攻击的结果#####
            r_a.gen_Attack_Result()
            #####产生的用于黑盒的攻击样本，并给出路径#####
            path_adv_xs,path_adv_ys,path_adv_xs_json,path_adv_ys_json=r_a.gen_adv_save_result()
        ...
        return path_adv_xs_list,path_adv_ys_list,path_adv_xs_json_list,path_adv_ys_json_list
#####如果不是光生成攻击样本，而是用黑盒的预测结果来进行评测#####
        ...
        for f in files:
            ...
            r_a = Rebust_Attack(arg1.attack_method, image_path,
                                label_path, image_origin_path,
                                label_origin_path, int(arg1.GPU_Config[0]), arg1.GPU_Config[1], 10,
                                arg1.Scale_ImageSize,
                                arg1.Crop_ImageSize, arg1.model,arg1.model_dir, arg1.defense_model,arg1.model_defence_dir,arg1.data_type,arg1.IS_WHITE,\
                              arg1.IS_SAVE,arg1.IS_COMPARE_MODEL,arg1.IS_TARGETTED,arg1.save_path,arg1.save_method,arg1.black_Result_dir,arg1.batch_size)
            #####获得攻击样本#####
            ...
            if not arg1.IS_COMPARE_MODEL:
                 ...
                 black_origin_outputs, black_adv_outputs,black_defense_origin_outputs,black_defense_adv_outputs= r_a.load_black_Json_Result(f)
            device = r_a.device
            ...
            #####新建的测评类的对象#####
            r_e=Rebust_Evaluate(tensor_adv_xs, tensor_cln_xs, tensor_cln_ys, tensor_adv_ys, tensor_ys_targeted,\
                                evaluation_method=arg2.evaluation_method,IS_PYTHORCH_WHITE=arg2.IS_PYTHORCH_WHITE,\
                                IS_COMPARE_MODEL=arg2.IS_COMPARE_MODEL,IS_TARGETTED=arg2.IS_TARGETTED)
            ...
            #####在两个模型比较的测评方法下#####
                rst = r_e.gen_evaluate(black_origin_outputs, black_adv_outputs,black_defense_origin_outputs,black_defense_adv_outputs)

            #log信息
            #####保存测评信息，攻击方法，评测方法和对应的结果到指定目录文件下#####
            SaveWithJson_Result(arg1.save_visualization_base_path, "table_list", attName[0], f, arg2.evaluation_method,
                                rst)
            print("Evaluation output : ", rst)
            update_current_status(arg1.save_visualization_base_path, attName[0],
            ...
            #####展示和保存可解释性分析的结果#####
            Save_Eval_Visualization_Result(attName, arg1.data_type, f, arg1.Dict_path, device, adv_xs_npy,
                                           arg1.save_visualization_base_path, \
                                           arg1.IS_COMPARE_MODEL, arg1.model, arg1.defense_model, \
                                           model, defense_model, arg2.CAM_layer, \
                                           image_origin_path, label_path, \
                                           black_adv_outputs, black_origin_outputs, \
                                           black_defense_adv_outputs, black_defense_origin_outputs,topk_show_list=topk_show_list)
...
if __name__ == '__main__':
    ...
    parser1.add_argument(
        ...
        type=str,
        nargs='*',
        default=["../Datasets/CIFAR_cln_data/cifar10_30_origin_inputs.npy", "../Datasets/CIFAR_cln_data/cifar10_30_origin_labels.npy",
    ...
    parser1.add_argument(
        '--IS_DOCKER_BLACK', type=bool, default=True)
    parser1.add_argument(
        '--ONLY_GENRATE_BLACK_SAMPLE', type=bool, default=False)
    parser1.add_argument(
        '--IS_SAVE',
        type=bool,
        default=True)
    parser1.add_argument(
        '--black_Result_dir' ,
        type=str,
        default ="../Datasets/adv_data/zjx.json")
    parser1.add_argument(

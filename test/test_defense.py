...
#####建立防御类对象#####
    r_a = Rebust_Defense(args.defense_method,image_path,
                        label_path, image_valid_path,
                        label_valid_path, 1, "0", 10, args.Scale_ImageSize, args.Crop_ImageSize, kwargs=args)
######产生训练数据集#####
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        type=str,
        nargs='*',
        default=["../Datasets/CIFAR_cln_data/cifar10_300_origin_inputs.npy", "../Datasets/CIFAR_cln_data/cifar10_300_origin_labels.npy", \

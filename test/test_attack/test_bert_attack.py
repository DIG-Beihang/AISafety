...
from text.Datasets.amazon_reviews_zh import AmazonReviewsZH  # noqa: F401
from text.Datasets.sst import SST
from text.EvalBox.Attack.bert_attack import BERTAttack
...
def run(test_num: int = 3):
    ...
    attacker_en = TextFooler(language="en", verbose=2)
    ...
    attacker_zh = BERTAttack(language="zh", verbose=2)

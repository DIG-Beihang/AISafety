...
class RAND(Defense):
    ...
    def randomization_transformation(self, samples=None, original_size=None, final_size=None):
        ...
        for image in samples:
            ...
            rnd = np.random.randint(original_size, final_size) #original_size和final_size之间的一个随机数
    ...
    def train(self, train_loader=None, epoch=None):
        ...
        for index, (images, labels) in enumerate(train_loader):
            ...
            adv_images = self.randomization_transformation(samples=images,
                                                                           original_size=images.shape[-1],
                                                                           final_size=self.resize)
            ...
            print(
                    '\rTrain Epoch {:>2}: [batch:{:>4}/{:>4}]  \tloss_rand={:.4f}, loss_adv={:.4f}, total_loss={:.4f} ===> '
                        .format(epoch, index, len(train_loader), loss_rand.item(),

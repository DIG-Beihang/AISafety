...
class PAT(Defense):
    ...
    def train(self, train_loader=None, epoch=None):
        ...
        for index, (images, labels) in enumerate(train_loader):
            ...
            self.model.eval()
            adv_images = self._pgd_generation(var_natural_images=pat_images, var_natural_labels=pat_labels)
            ...
            print(
                '\rTrain Epoch {:>2}: [batch:{:>4}/{:>4}]  \tloss_pat={:.4f}, loss_adv={:.4f}, total_loss={:.4f} ===> '
                .format(epoch, index, len(train_loader), loss_pat.item(),

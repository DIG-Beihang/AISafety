...
from utils.file_utils import get_user_model,get_user_model_origin,get_user_model_defense
...
class Rebust_Defense(Evaluation_Base):
    def __init__(self, defense_method=None, sample_path=None, label_path=None,image_origin_path=None,
                    label_origin_path=None,
                 gpu_counts=None, gpu_indexs=None, seed=None, Scale_ImageSize=None,Crop_ImageSize=None, kwargs=None):

        self._parse_params(kwargs)
        super(Rebust_Defense, self).__init__(defense_method, sample_path, label_path,image_origin_path,label_origin_path,
                                          gpu_counts, gpu_indexs, seed, Scale_ImageSize,Crop_ImageSize,    model=None,model_dir=None, \
                                             defense_model=None,model_defence_dir=None,data_type=None,IS_WHITE=None,\
                              IS_SAVE=None,IS_COMPARE_MODEL=None,IS_TARGETTED=None,save_path=None,save_method=None,black_Result_dir=None,batch_size=None)  # some model that in different setting
    ...
    def gen_dataloader(self):
        ...
        device, dataloader, dataset = self.setting_data(self.Scale_ImageSize,self.sample_path,self.label_path, \
            self.image_origin_path,self.label_origin_path)
    ...
    def gen_defense(self,train_loader, valid_loader):
        ...
        defense_enhanced_saver = self.Enhanced_model_save_path+'/{}/{}_{}_enhanced.pt'. \
            format(dfs_name, self.data_type, dfs_name)

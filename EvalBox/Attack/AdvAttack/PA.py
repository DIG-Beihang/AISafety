...
class PA(Attack):
    ...
    def pad_transform(self,patch, image_w, image_h, offset_x, offset_y):
        ...
        pad = nn.ConstantPad2d((offset_x - patch_x // 2, image_w - patch_x - offset_x + patch_x // 2, \
                                offset_y - patch_y // 2, image_h - patch_y - offset_y + patch_y // 2),
    ...
    def generate(self, xs=None, ys=None):
        ...
        offset_x, offset_y = int(self.position.split(',')[0]),int(self.position.split(',')[1])
       ...
       # print(copy_xs.shape)
        for i,image_xs in enumerate(var_xs):
           ...
           padded_patch= self.pad_transform(patch, image_w, image_h, offset_x, offset_y)
